#pragma config(Sensor, port11, ClawStopBtn,    sensorVexIQ_Touch)
#pragma config(Sensor, port12, speedLight,     sensorVexIQ_LED)
...
task main()
{
	...
	repeat(forever){
		...
		armControl(FrontClaw, BtnRUp, clawStop(), 100);
